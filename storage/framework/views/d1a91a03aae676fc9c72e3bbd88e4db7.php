                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo e(route('roles.edit', $role->id)); ?>"
                                                ...
                                                <form id="deleteRoleForm<?php echo e($role->id); ?>" action="<?php echo e(route('roles.destroy', $role->id)); ?>" method="POST" class="d-inline">
                                                  <?php echo csrf_field(); ?>
                                                  <?php echo method_field('DELETE'); ?>
                                                  <button type="submit" class="btn btn-sm btn-danger delete-role-btn" data-role-id="<?php echo e($role->id); ?>">
