                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" value="<?php echo e($user->first_name); ?>" class="form-control">
                            </div>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <input type="text" id="contact" name="contact" value="<?php echo e($user->phone_number); ?>" class="form-control">
                            </div>
                            <div class="form-group mt-2">
                                <label for="address">Address:</label>
                                <input type="text" id="address" name="address" value="<?php echo e($user->address); ?>" class="form-control">
                            </div>
                            <div class="form-group mt-2">
