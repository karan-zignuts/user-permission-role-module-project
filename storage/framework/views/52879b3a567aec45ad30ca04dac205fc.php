                                ...
                                <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($module->parent()->count() > 0): ?>
                                        <tr>
                                            ...
                                            <td><input type="checkbox" class="selectAll" data-target="module<?php echo e($module->code); ?>"> Select All</td>
                                            <td><input type="checkbox" name="permissions[<?php echo e($module->code); ?>][create]"
                                            ...
                                            <td><input type="checkbox" name="permissions[<?php echo e($module->code); ?>][view]"
                                                    class="permissionCheckbox module<?php echo e($module->code); ?>"></td>
                                            <td><input type="checkbox" name="permissions[<?php echo e($module->code); ?>][delete]"
                                                    class="permissionCheckbox module<?php echo e($module->code); ?>"></td>
                                        </tr>
                                    <?php endif; ?>
