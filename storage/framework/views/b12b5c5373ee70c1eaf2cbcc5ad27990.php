...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <?php $__currentLoopData = $menuData->menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(($userEmail === 'hardik@gmail.com' && $menu->role === 'admin') ||($userEmail != 'hardik@gmail.com' && $menu->role === 'user')): ?>
                <li class="menu-item <?php echo e($activeClass); ?>">
                    ...
                    <a href="<?php echo e(isset($menu->url) ? url($menu->url) : 'javascript:void(0);'); ?>"
                        ...
                        <?php if(isset($menu->badge)): ?>
                            <div class="badge bg-label-<?php echo e($menu->badge[0]); ?> rounded-pill ms-auto"><?php echo e($menu->badge[1]); ?>
  ...
  <?php /**PATH /Users/ztlab113/Desktop/project /Laravel/user-permission-role-module/resources/views/layouts/sections/menu/verticalMenu.blade.php ENDPATH**/ ?>