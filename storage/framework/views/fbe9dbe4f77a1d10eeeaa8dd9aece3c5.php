...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        ...
        <a href="<?php echo e(route('permissions.create')); ?>" class="btn btn-primary mb-4"><i class="fas fa-plus"></i> Create New
            Permission</a>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <select name="status" class="form-control">
                        ...
                        <option value="inactive" <?php echo e(request()->input('status') == 'inactive' ? 'selected' : ''); ?>>Inactive
                        </option>
                    </select>
                </div>
                <div class="col-md-2">
                            ...
                            <td>
                                <div class="form-check form-switch">
                                    <input class="form-check-input toggle-class" type="checkbox"
                                        data-permission-id="<?php echo e($permission->id); ?>" id="flexSwitchCheck<?php echo e($permission->id); ?>"
                                        <?php echo e($permission->is_active ? 'checked' : ''); ?>>
                                    <label class="form-check-label" for="flexSwitchCheck<?php echo e($permission->id); ?>"></label>
                                </div>
                            </td>
                            <td>
                                <a href="<?php echo e(route('permissions.edit', $permission->id)); ?>" class="btn btn-info btn-sm"><i
                                        class="fas fa-edit"></i> </a>
                                        <form action="<?php echo e(route('permissions.destroy', $permission->id)); ?>" method="POST" class="d-inline" id="deletePermissionForm">
                                          <?php echo csrf_field(); ?>
      ...
      $(document).ready(function () {
          ...
          $('.toggle-class').change(function () {
              ...
              $.ajax({
                  type: "POST",
                  dataType: "json",
                  url: '<?php echo e(route('permissions.toggleStatus', ':permission_id')); ?>'.replace(':permission_id', permission_id),
                  headers: {
